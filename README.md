...
```
cd existing_repo
git remote add origin https://gitlab.indonesiare.co.id/root/alea.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.indonesiare.co.id/root/alea/-/settings/integrations)
...
>>>>>>> 785cba169602bb3d937816135af7e693471c70a5
