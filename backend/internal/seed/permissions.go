...
func permissionSeedData() []entity.Permission {
	return []entity.Permission{
		...
		perm("agreement_document.view.own", "agreement_document", "view", "own", "Perjanjian - Lihat Milik Sendiri", "Melihat pengajuan sendiri"),
		perm("agreement_document.view.all", "agreement_document", "view", "all", "Perjanjian - Lihat Semua", "Melihat semua pengajuan"),
		perm("agreement_document.create.own", "agreement_document", "create", "own", "Perjanjian - Buat", "Membuat pengajuan"),
		perm("agreement_document.update.own", "agreement_document", "update", "own", "Perjanjian - Edit", "Mengedit pengajuan"),
		perm("agreement_document.delete.own", "agreement_document", "delete", "own", "Perjanjian - Hapus", "Menghapus pengajuan"),
		perm("agreement_document.resubmit.own", "agreement_document", "resubmit", "own", "Perjanjian - Ajukan Ulang", "Mengajukan ulang"),
		perm("agreement_document.preview.own", "agreement_document", "preview", "own", "Perjanjian - Preview Sendiri", "Preview PDF sendiri"),
		perm("agreement_document.preview.all", "agreement_document", "preview", "all", "Perjanjian - Preview Semua", "Preview seluruh PDF"),
		perm("agreement_document.download_attachment.own", "agreement_document", "download_attachment", "own", "Perjanjian - Attachment Sendiri", "Download attachment sendiri"),
		perm("agreement_document.download_attachment.all", "agreement_document", "download_attachment", "all", "Perjanjian - Semua Attachment", "Download semua attachment"),
		perm("agreement_document.update_meta.all", "agreement_document", "update_meta", "all", "Perjanjian - Review Metadata", "Mengoreksi metadata"),
		perm("agreement_document.update_status.all", "agreement_document", "update_status", "all", "Perjanjian - Ubah Status", "Review dan approval"),
		perm("agreement_document.download_pdf.own", "agreement_document", "download_pdf", "own", "Perjanjian - PDF Sendiri", "Download PDF sendiri"),
		perm("agreement_document.download_pdf.all", "agreement_document", "download_pdf", "all", "Perjanjian - Semua PDF", "Download semua PDF"),
