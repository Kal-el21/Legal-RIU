...
interface SharedLegalOpinionDetailPageProps {
...
export default function SharedLegalOpinionDetailPage({
  showDownloadPDF = false,
  downloadPDFMutation,
  onBack,
  children,
}: SharedLegalOpinionDetailPageProps) {
  ...
  const handleDownloadPDF = async () => {
    if (!lo || !id || !downloadPDFMutation) return
