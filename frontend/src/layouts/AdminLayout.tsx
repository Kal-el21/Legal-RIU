...
import { Scale, LayoutDashboard, FileText, FileSearch, FileStack, Users, Menu, ChevronRight, ChevronLeft, ScrollText, Building2, Target, Briefcase, MapPin, UserCog, FolderOpen, BarChart3 } from 'lucide-react'
...
const DATA_MASTER_ITEMS = [
  ...
  { label: 'Pihak Pertama', href: '/admin/company-masters', icon: Building2, permissions: ['master_data.manage'] },
]
...
const NAV = [
  ...
  { label: 'Dokumen Perjanjian', href: '/admin/agreement-documents', icon: FileStack, permissions: ['agreement_document.view.all'] },
