...
import { Scale, LayoutDashboard, FileText, FileSearch, Users, Menu, ChevronRight, ChevronLeft, ScrollText, Building2, Target, Briefcase, MapPin, UserCog, FolderOpen, BarChart3, Files } from 'lucide-react'
...
const NAV = [
  ...
  { label: 'Dokumen Repository', href: '/admin/repository-documents', icon: Files, permissions: ['document_repository.view'] },
