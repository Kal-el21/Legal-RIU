...
import { Scale, LayoutDashboard, FileText, FileSearch, FileStack, Menu, ChevronRight, ChevronLeft, ScrollText, BarChart3 } from 'lucide-react'
...
const NAV = [
  ...
  { label: 'Dokumen Perjanjian', href: '/legal/agreement-documents', icon: FileStack, permissions: ['agreement_document.view.all'] },
