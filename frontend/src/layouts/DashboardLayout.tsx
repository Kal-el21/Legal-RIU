...
import { Scale, LayoutDashboard, FileText, FileSearch, Menu, ChevronRight, ChevronLeft, BriefcaseBusiness, ScrollText, Files } from 'lucide-react'
...
const NAV = [
  ...
  { label: 'Dokumen Repository', href: '/dashboard/repository-documents', icon: Files, permissions: ['document_repository.view'] },
