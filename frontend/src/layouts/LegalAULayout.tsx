...
const NAV = [
  { label: 'Dashboard', href: '/legal-au', icon: LayoutDashboard, exact: true, permissions: ['dashboard.legal.view'] },
  ...
  { label: 'User Management', href: '/legal-au/users', icon: Users, permissions: ['user_management.view'] },
]
