...
export default function AdminLegalOpinionListPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold" style={{ color: '#0B2545' }}>Manage Legal Opinion</h1>
        <p className="text-sm text-gray-500 mt-0.5">Kelola seluruh pengajuan Legal Opinion</p>
      </div>
              ...
              {data.items.map((lo) => (
                <tr key={lo.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <Link to={`/admin/legal-opinions/${lo.id}`}
