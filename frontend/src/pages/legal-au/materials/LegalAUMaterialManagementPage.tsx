  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: '#0B2545' }}>Materi Legal</h1>
          <p className="text-sm text-gray-500 mt-0.5">Kelola materi legal</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-16 text-center"><p className="font-medium text-gray-500">Belum ada materi</p></div>
        ) : (
                ...
                <tr key={item.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1 justify-end">
                      <button onClick={() => { openEdit(item); navigate(`/legal-au/materials/${item.id}`) }} title="Edit" className="p-1.5 rounded-lg hover:bg-gray-100 transition-colors text-gray-400 hover:text-gray-700">
