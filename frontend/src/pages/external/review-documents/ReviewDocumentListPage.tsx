...
export default function ExternalReviewDocumentListPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-0.5">Lihat pengajuan Review Dokumen</p>
      </div>
              ...
              {data.items.map((dr) => (
                <tr key={dr.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <Link to={`/external/review-documents/${dr.id}`}
