...
export default function ExternalLegalOpinionListPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-0.5">Lihat pengajuan Legal Opinion</p>
      </div>
              ...
              {data.items.map((lo) => (
                <tr key={lo.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <Link to={`/external/legal-opinions/${lo.id}`}
