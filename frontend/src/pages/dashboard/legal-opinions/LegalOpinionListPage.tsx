  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: '#0B2545' }}>Legal Opinion</h1>
          <p className="text-sm text-gray-500 mt-0.5">Kelola pengajuan legal opinion Anda</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-16 text-center">
            ...
            <p className="text-sm text-gray-400 mt-1 mb-6">Buat pengajuan Legal Opinion pertama Anda</p>
            <Link to="/dashboard/legal-opinions/new">
            ...
            <tbody className="divide-y divide-gray-50">
              {data.items.map((lo) => (
                <tr key={lo.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <p className="text-sm font-medium text-gray-900 max-w-xs truncate">{lo.title}</p>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-right">
                    <Link to={`/dashboard/legal-opinions/${lo.id}`}
